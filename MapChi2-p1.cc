...
void MapChi2(string PID = "track") { //Segun la label, track, shower o ninguna de ellas, os hace esto para tracks, showers y middles
  ...
  TFile * f2 = new TFile("Events_1y_NO_Decay1e-5_upto100.root"); //El de arriba será para Data, el de abajo para Model
